...
//        String insert_url = "http://weijietest.000webhostapp.com/Mah/insert.php";
        String initAddress = Address.getAddress();
//        String initAddress = " http://172.17.193.212/Mah/";
        String insert_url = initAddress + "insert.php";

        if (type.equals("add")) {
            try {
                String nfc_serial = params[1];
                //String wardNum = params[2];
                String bedNum = params[2];
                String wardid = params[3];
                String iso = params[4];
                ...
                String post_data = URLEncoder.encode("serialnum", "UTF-8") + "=" + URLEncoder.encode(nfc_serial, "UTF-8")
                        + "&" + URLEncoder.encode("wardid", "UTF-8") + "=" + URLEncoder.encode(wardid, "UTF-8")
